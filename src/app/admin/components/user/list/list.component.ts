...
import { AuthorizeUserDialogComponent } from '../../../../dialogs/authorize-user-dialog/authorize-user-dialog.component/authorize-user-dialog.component';
...
export class ListComponent extends BaseComponent implements OnInit {
  ...
  assignRole(id: string) {
    this.dialogService.openDialog({
      ...
      afterClosed: () => {
        this.alertifyService.message("roles successully set", {
